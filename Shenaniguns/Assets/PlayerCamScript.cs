...
public class PlayerCamScript : MonoBehaviour {
    ...
    private const float CAM_DIST_MAX = 15.0f;
    private const float CAM_DIST_MIN = 5.0f;

    [Header("Transforms")]
    public Transform lookAt;
	public BasicPlayerScript playerScript;
    ...
    void Start()
    {
		...
		playerScript = lookAt.GetComponent<BasicPlayerScript>();
    }
    ...
    void LateUpdate()
    {
        ...
        distance.z = Mathf.Clamp(distance.z, CAM_DIST_MIN, CAM_DIST_MAX);
